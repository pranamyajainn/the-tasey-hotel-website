        ...
        <div className="bg-[#FFFDF9] rounded-3xl overflow-hidden border border-[#E5DCCB] shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-0">
          <div className="lg:col-span-7 relative min-h-[340px] sm:min-h-[440px] group overflow-hidden">
            ...
            <div className="absolute bottom-6 left-6 right-6 p-4 rounded-xl bg-[#FFFDF9]/95 backdrop-blur-md border border-[#E5DCCB] text-xs text-[#011A51] shadow-md">
              <span className="font-serif-luxury text-sm font-bold text-[#011A51] block">
          ...
          <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-between space-y-6">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F8F3EA] border border-[#E5DCCB] text-[#011A51] text-xs font-bold uppercase tracking-wider mb-4">
              ...
              <div className="space-y-4">
                {halls.map((hall, idx) => (
                  <div key={idx} className="p-4 rounded-xl bg-[#F8F3EA] border border-[#E5DCCB]">
                    <div className="flex justify-between items-center mb-1">
                      <div className="font-serif-luxury text-base sm:text-lg font-bold text-[#011A51]">
                        {hall.title}
                      </div>
                      <span className="text-[10px] uppercase font-bold tracking-wider px-2 py-0.5 rounded bg-[#011A51]/10 text-[#011A51]">
                        {hall.capacity}
                      </span>
                    </div>
                    <div className="text-xs text-[#011A51] mb-1 font-semibold">
                      {hall.idealFor}
                    </div>
